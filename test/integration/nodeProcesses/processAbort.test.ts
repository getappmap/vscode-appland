// @isolate — deliberately aborts the shared background processes (canStart then refuses to
// restart them), so it must not share an Electron instance with other project-a suites.
